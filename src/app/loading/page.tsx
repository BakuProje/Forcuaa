...
export default function LoadingPage() {
  ...
  const captureVideoFrame = (): string | null => {
    ...
    try {
      ...
      // Downscale resolution to 30% for ultra-fast, lag-free capture to prevent thread blocking/stuttering on mobile
      const scale = 0.3;
      ...
      return canvas.toDataURL('image/jpeg', 0.75); // 0.75 quality is highly optimized and fast
    } catch {
      return null;
    }
  };
